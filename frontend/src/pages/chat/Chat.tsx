...
import Ucd from "../../assets/Ucd.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>What would you like to know?</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is trained on the UC Davis public knowledge base and is ready to answer your questions</h2>
                            </Stack>
                        ) : (
